      ...
      <div class="bg-light border-right" id="sidebar-wrapper">
        ...
        <div class="list-group list-group-flush">
          ...
          <div style="text-indent: 4px;" class="collapse show" id="reserveSubmenu">
            <a href="pending.php" class="list-group-item list-group-item-action text-primary">Pending</a>
        ...
        <div class="container-fluid border" style="width: auto; margin: 30px; padding: 15px;">
          <div class="table-wrapper">
            <div class="table-title">
              <div class="row">
                <div class="col-sm-12">
                  <h1 class="mt-1 mb-1 font-weight-normal">Manage Pending Reservations</h1>
                </div>
              </div>
            </div>
            <hr>
            <div class="table-responsive">
              <table class="table table-bordered table-sm" id="example">
                ...
                <tbody>
                  <?php
                  $sql = "SELECT * FROM tbl_reserve WHERE status = 'Pending'";
                  ...
                  if ($result->num_rows > 0) {
                    while($row = $result->fetch_assoc()) {
                      ...
                      <tr>
                        ...
                        <td>
                          <div class="dropdown">
                            ...
                            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                              <a class="dropdown-item small" href="#edit<?php echo $rid;?>" data-toggle="modal">Update Status</a>
                              <a class="dropdown-item small" href="#send<?php echo $rid;?>" data-toggle="modal">Send Approval</a>
                                  ...
                                  <div class="row">
                                    ...
                                    <div class="col-md-12">
                                      <div class="form-group">
                                        ...
                                        <input type="hidden" name="rdate" value="<?php echo $rdate; ?>" autocomplete="off">
                                      </div>
                                    </div>
                                  </div>
                                </div>
                        ...
                        <!-- Send Modal -->
                        <div id="send<?php echo $rid; ?>" class="modal fade">
                          <div class="modal-dialog">
                            <div class="modal-content">
                              <form method="post">
                                <div class="modal-header">
                                  <h4 class="modal-title font-weight-light">Send Approval Notification</h4>
                                  <button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
                                </div>
                                <div class="modal-body font-weight-normal">
                                  <input type="hidden" name="send_id" value="<?php echo $rid; ?>">
                                  <p>Are you sure you want to send an SMS?</p>
                                  <p><small>This action cannot be undone.</small></p>
                                </div>
                                <div class="modal-footer">
                                  <input type="button" class="btn btn-default" data-dismiss="modal" value="Cancel">
                                  <input type="submit" name="send" class="btn btn-primary" value="Send" autofocus>
                                </div>
                              </form>
                            </div>
                          </div>
                      ...
                      if(isset($_POST['update'])){
                        ...
                        if(mysqli_num_rows($query) > 0){
                          echo "<div class='text-danger'>Sorry you can only approved a one reservation per date!</div>";
                        }
                        else{
                          mysqli_query($conn, "UPDATE tbl_reserve SET 
                            status = '$status'
                            WHERE rid = '$edit_id'")or die(mysqli_error($conn));
                      ...
                      if (isset($_POST['send'])) {
                        ...
                        $number = $phone;
                        $result = itexmo($number, "Hello $fullname, your reservation is now approved!\r\n\r\nIf you do not settle your balance within two (2) days, your reservation will be terminate.\r\n\r\nIf there is any problem, please contact us. Thank you!\r\n\r\n", "ST-JANCH885733_CVBD4");
                        if ($result == ""){
